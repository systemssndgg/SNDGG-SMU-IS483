...
def find_price_per_hr(carpark, num_hrs, vehicle_type='Car'):
    ...
    if first_hour_rate != '-' or first_hour_rate != None:
        first_hour_rate_start_time = first_hour_rate['start_time']
        first_hour_rate_end_time = first_hour_rate['end_time']
